  ...
  return (
    <footer className='bg-gray-900 text-white'>
      <div className="md:flex md:justify-between sm:px-12 px-4 bg-[#ffffff19] py-7 md:items-center">
         <h1 className="lg:text-4xl text-3xl md:mb-0mb-6 lg:leading-normal font-semibold md:w-2/5">
         ...
         <div>
            ...
            <button className="bg-teal-400 hover:bg-teal-500 duration-300 px-5 py-2.5 font-[Poppin] rounded-md text-white md:w-auto w-full">Request Code</button>
         </div>
      </div>
      <ItemsContainer />
